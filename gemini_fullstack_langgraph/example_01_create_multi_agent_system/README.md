...
1. Type the following:
   ...
   ```bash
   cp -r "\path_to\AI-in-Trading-Workflow-main\AI-in-Trading-Workflow-main\gemini_fullstack_langchain\example_01_create_multi_agent_system" "\path2_to\gemini-fullstack-langgraph-quickstart-main\backend\example_01_create_multi_agent_system"
   ```
